...
export const EMOJI_CATEGORIES: EmojiCategory[] = [
  ...
  },
  {
    ...
    emojis: [
      ...
      { char: "🌎", name: "Earth Globe Americas", description: "The Earth showing the Americas. Represents the. Represents the world, travel, and our planet.", usage: ["Happy Earth Day! 🌎", "We are the world.", "Let's explore the globe."] },
  ...
  },
  {
    ...
    emojis: [
      ...
      { char: "⚽", name: "Football", description: "A classic black and white soccer ball. Represents the world's most popular sport.", usage: ["Game on! ⚽", "Let's play some football.", "Goal!"] },
      ...
      { char: "🏒", name: "Ice Hockey", description: "An ice hockey stick and puck. Represents the sport of ice hockey.", usage: ["He shoots, he scores! 🏒", "Let's go to the hockey game.", "A fast-paced winter sport."] },
      { char: "🏓", name: "Ping Pong", description: "A ping pong paddle and ball. Represents the sport of table tennis.", usage: ["A quick game of ping pong 🏓", "She's got a mean backhand.", "A fun and fast-paced game."] },
      { char: "🏸", name: "Badminton", description: "A badminton racket and shuttlecock. Represents the sport of badminton.", usage: ["Let's play some badminton in the park 🏸", "A light and graceful sport.", "The shuttlecock is also called a birdie."] },
      { char: "⛳", name: "Golf", description: "A flag in a hole on a golf course. Represents the sport of golf.", usage: ["A relaxing day on the golf course ⛳", "Hole in one!", "Time to tee off."] },
    ],
  },
  {
    name: "Travel & Places",
  ...
  },
  {
    ...
    emojis: [
      ...
      { char: "🇦🇫", name: "Afghanistan", description: "The national flag of Afghanistan.", usage: ["Visiting Kabul.", "News from Afghanistan."] },
      { char: "🇦🇽", name: "Åland Islands", description: "The flag of the Åland Islands.", usage: ["Sailing in the Åland archipelago.", "A beautiful part of Finland."] },
      { char: "🇦🇱", name: "Albania", description: "The national flag of Albania.", usage: ["Exploring the Albanian Riviera.", "The eagle on the flag is iconic."] },
      { char: "🇩🇿", name: "Algeria", description: "The national flag of Algeria.", usage: ["The beauty of the Sahara in Algeria.", "A trip to Algiers."] },
      { char: "🇦🇸", name: "American Samoa", description: "The flag of American Samoa.", usage: ["The stunning nature of American Samoa.", "A territory of the USA in the Pacific."] },
      { char: "🇦🇩", name: "Andorra", description: "The national flag of Andorra.", usage: ["Skiing in the Pyrenees in Andorra.", "A tiny country with a big heart."] },
      { char: "🇦🇴", name: "Angola", description: "The national flag of Angola.", usage: ["The vibrant culture of Angola.", "Exploring Luanda."] },
      { char: "🇦🇮", name: "Anguilla", description: "The flag of Anguilla.", usage: ["Relaxing on the beaches of Anguilla.", "A beautiful Caribbean island."] },
      { char: "🇦🇶", name: "Antarctica", description: "The flag of Antarctica.", usage: ["An expedition to the South Pole.", "The coldest continent on Earth."] },
      { char: "🇦🇬", name: "Antigua & Barbuda", description: "The national flag of Antigua & Barbuda.", usage: ["Sailing around Antigua and Barbuda.", "365 beaches, one for every day."] },
      { char: "🇦🇷", name: "Argentina", description: "The national flag of Argentina.", usage: ["Tango in Buenos Aires.", "The sun of May is shining."] },
      { char: "🇦🇲", name: "Armenia", description: "The national flag of Armenia.", usage: ["Visiting ancient monasteries in Armenia.", "The rich history of Yerevan."] },
      { char: "🇦🇼", name: "Aruba", description: "The flag of Aruba.", usage: ["One happy island, Aruba.", "Enjoying the clear blue waters."] },
      { char: "🇦🇺", name: "Australia", description: "The flag of Australia.", usage: ["G'day mate! 🇦🇺", "Throw another shrimp on the barbie.", "Down under."] },
      { char: "🇦🇹", name: "Austria", description: "The national flag of Austria.", usage: ["The sound of music in Salzburg.", "A trip to Vienna."] },
      { char: "🇦🇿", name: "Azerbaijan", description: "The national flag of Azerbaijan.", usage: ["The Flame Towers in Baku are amazing.", "The Land of Fire."] },
      { char: "🇧🇸", name: "Bahamas", description: "The national flag of the Bahamas.", usage: ["Swimming with pigs in the Bahamas.", "It's better in the Bahamas."] },
      { char: "🇧🇭", name: "Bahrain", description: "The national flag of Bahrain.", usage: ["The modern architecture of Manama.", "A pearl in the Persian Gulf."] },
      { char: "🇧🇩", name: "Bangladesh", description: "The national flag of Bangladesh.", usage: ["The lush green landscapes of Bangladesh.", "Exploring Dhaka."] },
      { char: "🇧🇧", name: "Barbados", description: "The national flag of Barbados.", usage: ["Rihanna's home country!", "Enjoying the sun in Barbados."] },
      { char: "🇧🇾", name: "Belarus", description: "The national flag of Belarus.", usage: ["The clean streets of Minsk.", "Exploring the history of Belarus."] },
      { char: "🇧🇪", name: "Belgium", description: "The national flag of Belgium.", usage: ["Eating waffles and chocolate in Brussels.", "The home of the European Union."] },
      { char: "🇧🇿", name: "Belize", description: "The national flag of Belize.", usage: ["Diving in the Great Blue Hole in Belize.", "A beautiful Central American country."] },
      { char: "🇧🇯", name: "Benin", description: "The national flag of Benin.", usage: ["The history of the Dahomey Kingdom.", "Exploring the culture of Benin."] },
      { char: "🇧🇲", name: "Bermuda", description: "The flag of Bermuda.", usage: ["The famous pink sand beaches of Bermuda.", "The mysterious Bermuda Triangle."] },
      { char: "🇧🇹", name: "Bhutan", description: "The national flag of Bhutan.", usage: ["The land of the Thunder Dragon.", "Measuring Gross National Happiness."] },
      { char: "🇧🇴", name: "Bolivia", description: "The national flag of Bolivia.", usage: ["The salt flats of Uyuni are breathtaking.", "A country of incredible landscapes."] },
      { char: "🇧🇦", name: "Bosnia & Herzegovina", description: "The national flag of Bosnia & Herzegovina.", usage: ["The historic bridge of Mostar.", "The beautiful city of Sarajevo."] },
      { char: "🇧🇼", name: "Botswana", description: "The national flag of Botswana.", usage: ["A safari in the Okavango Delta.", "The stunning wildlife of Botswana."] },
      { char: "🇧🇷", name: "Brazil", description: "The national flag of Brazil.", usage: ["Let's go to Brazil! 🇧🇷", "Carnival in Rio.", "The beautiful game."] },
      { char: "🇮🇴", name: "British Indian Ocean Territory", description: "The flag of the British Indian Ocean Territory.", usage: ["A remote and beautiful part of the world.", "The Chagos Archipelago."] },
      { char: "🇻🇬", name: "British Virgin Islands", description: "The flag of the British Virgin Islands.", usage: ["Sailing through the beautiful BVI.", "A paradise for sailors."] },
      { char: "🇧🇳", name: "Brunei", description: "The national flag of Brunei.", usage: ["The magnificent mosques of Brunei.", "A small, wealthy nation."] },
      { char: "🇧🇬", name: "Bulgaria", description: "The national flag of Bulgaria.", usage: ["Enjoying the Black Sea coast in Bulgaria.", "The rich history of Sofia."] },
      { char: "🇧🇫", name: "Burkina Faso", description: "The national flag of Burkina Faso.", usage: ["The vibrant arts scene in Ouagadougou.", "The Land of Upright People."] },
      { char: "🇧🇮", name: "Burundi", description: "The national flag of Burundi.", usage: ["The heart of Africa.", "Exploring the culture of Burundi."] },
      { char: "🇰🇭", name: "Cambodia", description: "The national flag of Cambodia.", usage: ["Visiting the ancient temples of Angkor Wat.", "The history of Phnom Penh."] },
      { char: "🇨🇲", name: "Cameroon", description: "The national flag of Cameroon.", usage: ["Africa in miniature.", "The diverse landscapes of Cameroon."] },
      { char: "🇨🇦", name: "Canada", description: "The flag of Canada (Maple Leaf).", usage: ["Oh, Canada! 🇨🇦", "Proud to be Canadian.", "Sorry!"] },
      { char: "🇮🇨", name: "Canary Islands", description: "The flag of the Canary Islands.", usage: ["A vacation in Tenerife.", "The beautiful Spanish islands."] },
      { char: "🇨🇻", name: "Cape Verde", description: "The national flag of Cape Verde.", usage: ["The music and culture of Cape Verde.", "A beautiful archipelago off Africa."] },
      { char: "🇧🇶", name: "Caribbean Netherlands", description: "The flag of the Caribbean Netherlands.", usage: ["Diving in Bonaire.", "The beautiful islands of the Dutch Caribbean."] },
      { char: "🇰🇾", name: "Cayman Islands", description: "The flag of the Cayman Islands.", usage: ["The financial hub of the Caribbean.", "Stingray City is a must-see."] },
      { char: "🇨🇫", name: "Central African Republic", description: "The national flag of the Central African Republic.", usage: ["The heart of Africa.", "A country with rich natural resources."] },
      { char: "🇹🇩", name: "Chad", description: "The national flag of Chad.", usage: ["The vast Sahara desert in Chad.", "The dead heart of Africa."] },
      { char: "🇨🇱", name: "Chile", description: "The national flag of Chile.", usage: ["The mysterious statues of Easter Island.", "The long, narrow country of South America."] },
      { char: "🇨🇳", name: "China", description: "The flag of China.", usage: ["A trip to the Great Wall 🇨🇳", "Happy Chinese New Year!", "The Middle Kingdom."] },
      { char: "🇨🇽", name: "Christmas Island", description: "The flag of Christmas Island.", usage: ["The famous red crab migration.", "A remote Australian territory."] },
      { char: "🇨🇨", name: "Cocos (Keeling) Islands", description: "The flag of the Cocos (Keeling) Islands.", usage: ["A beautiful and remote coral atoll.", "Australia's last untouched paradise."] },
      { char: "🇨🇴", name: "Colombia", description: "The national flag of Colombia.", usage: ["The vibrant colors of Cartagena.", "The land of coffee and emeralds."] },
      { char: "🇰🇲", name: "Comoros", description: "The national flag of the Comoros.", usage: ["The perfume islands of the Indian Ocean.", "A beautiful and unique culture."] },
      { char: "🇨🇬", name: "Congo - Brazzaville", description: "The national flag of the Republic of the Congo.", usage: ["Exploring the rainforests of Congo.", "The vibrant city of Brazzaville."] },
      { char: "🇨🇩", name: "Congo - Kinshasa", description: "The national flag of the Democratic Republic of the Congo.", usage: ["The mighty Congo River.", "The music and culture of Kinshasa."] },
      { char: "🇨🇰", name: "Cook Islands", description: "The flag of the Cook Islands.", usage: ["A paradise in the South Pacific.", "The beautiful lagoon of Aitutaki."] },
      { char: "🇨🇷", name: "Costa Rica", description: "The national flag of Costa Rica.", usage: ["Pura Vida! The motto of Costa Rica.", "The amazing biodiversity of the rainforests."] },
      { char: "🇨🇮", name: "Côte d’Ivoire", description: "The national flag of Côte d’Ivoire (Ivory Coast).", usage: ["The economic hub of West Africa.", "The beautiful beaches of the Ivory Coast."] },
      { char: "🇭🇷", name: "Croatia", description: "The national flag of Croatia.", usage: ["The stunning coastline of the Adriatic Sea.", "Game of Thrones was filmed here!"] },
      { char: "🇨🇺", name: "Cuba", description: "The national flag of Cuba.", usage: ["The classic cars and colorful streets of Havana.", "The rhythm of salsa music."] },
      { char: "🇨🇼", name: "Curaçao", description: "The flag of Curaçao.", usage: ["The colorful Dutch architecture of Willemstad.", "A beautiful Caribbean island."] },
      { char: "🇨🇾", name: "Cyprus", description: "The national flag of Cyprus.", usage: ["The island of love.", "The beautiful beaches and ancient history of Cyprus."] },
      { char: "🇨🇿", name: "Czechia", description: "The national flag of Czechia (Czech Republic).", usage: ["The fairy-tale city of Prague.", "A country with a rich history and beautiful castles."] },
      { char: "🇩🇰", name: "Denmark", description: "The national flag of Denmark.", usage: ["The home of hygge and happiness.", "The land of Vikings and fairy tales."] },
      { char: "🇩🇯", name: "Djibouti", description: "The national flag of Djibouti.", usage: ["A strategic location in the Horn of Africa.", "The unique landscapes of Lake Assal."] },
      { char: "🇩🇲", name: "Dominica", description: "The national flag of Dominica.", usage: ["The nature island of the Caribbean.", "A paradise for hikers and nature lovers."] },
      { char: "🇩🇴", name: "Dominican Republic", description: "The national flag of the Dominican Republic.", usage: ["The beautiful beaches of Punta Cana.", "The rhythm of merengue and bachata."] },
      { char: "🇪🇨", name: "Ecuador", description: "The national flag of Ecuador.", usage: ["The amazing wildlife of the Galápagos Islands.", "A country on the equator."] },
      { char: "🇪🇬", name: "Egypt", description: "The national flag of Egypt.", usage: ["The ancient pyramids of Giza.", "A cruise down the Nile River."] },
      { char: "🇸🇻", name: "El Salvador", description: "The national flag of El Salvador.", usage: ["The land of volcanoes.", "Surfing the waves of El Salvador."] },
      { char: "🇬🇶", name: "Equatorial Guinea", description: "The national flag of Equatorial Guinea.", usage: ["A country with rich oil reserves.", "Exploring the biodiversity of Equatorial Guinea."] },
      { char: "🇪🇷", name: "Eritrea", description: "The national flag of Eritrea.", usage: ["The unique architecture of Asmara.", "A country with a rich history in the Horn of Africa."] },
      { char: "🇪🇪", name: "Estonia", description: "The national flag of Estonia.", usage: ["The digital nation of Europe.", "The medieval old town of Tallinn."] },
      { char: "🇸🇿", name: "Eswatini", description: "The national flag of Eswatini (formerly Swaziland).", usage: ["The kingdom of Eswatini.", "A country with a rich culture and beautiful nature reserves."] },
      { char: "🇪🇹", name: "Ethiopia", description: "The national flag of Ethiopia.", usage: ["The birthplace of coffee.", "The ancient rock-hewn churches of Lalibela."] },
      { char: "🇪🇺", name: "European Union", description: "The flag of the European Union.", usage: ["United in diversity.", "A symbol of European cooperation."] },
      { char: "🇫🇰", name: "Falkland Islands", description: "The flag of the Falkland Islands.", usage: ["A remote archipelago in the South Atlantic.", "Home to amazing wildlife, including penguins."] },
      { char: "🇫🇴", name: "Faroe Islands", description: "The flag of the Faroe Islands.", usage: ["The stunning landscapes of the Faroe Islands.", "A paradise for hikers and photographers."] },
      { char: "🇫🇯", name: "Fiji", description: "The national flag of Fiji.", usage: ["Bula! Welcome to Fiji.", "A paradise of beautiful islands and friendly people."] },
      { char: "🇫🇮", name: "Finland", description: "The national flag of Finland.", usage: ["The land of a thousand lakes and forests.", "Hoping to see the Northern Lights."] },
      { char: "🇫🇷", name: "France", description: "The flag of France.", usage: ["Vive la France! 🇫🇷", "A romantic trip to Paris.", "Croissants and coffee."] },
      { char: "🇬🇫", name: "French Guiana", description: "The flag of French Guiana.", usage: ["The Guiana Space Centre.", "A piece of France in South America."] },
      { char: "🇵🇫", name: "French Polynesia", description: "The flag of French Polynesia.", usage: ["The beautiful islands of Tahiti and Bora Bora.", "A dream honeymoon destination."] },
      { char: "🇹🇫", name: "French Southern Territories", description: "The flag of the French Southern Territories.", usage: ["A remote and inhospitable part of the world.", "A haven for scientific research."] },
      { char: "🇬🇦", name: "Gabon", description: "The national flag of Gabon.", usage: ["The amazing biodiversity of Gabon's rainforests.", "A country with a strong commitment to conservation."] },
      { char: "🇬🇲", name: "Gambia", description: "The national flag of the Gambia.", usage: ["The smiling coast of Africa.", "A popular destination for birdwatching."] },
      { char: "🇬🇪", name: "Georgia", description: "The national flag of Georgia.", usage: ["The birthplace of wine.", "The beautiful Caucasus Mountains."] },
      { char: "🇩🇪", name: "Germany", description: "The flag of Germany.", usage: ["Autobahn! 🇩🇪", "Made in Germany.", "Oktoberfest is here!"] },
      { char: "🇬🇭", name: "Ghana", description: "The national flag of Ghana.", usage: ["The gateway to West Africa.", "The rich history of the Ashanti Kingdom."] },
      { char: "🇬🇮", name: "Gibraltar", description: "The flag of Gibraltar.", usage: ["The Rock of Gibraltar.", "A piece of Britain on the Iberian Peninsula."] },
      { char: "🇬🇷", name: "Greece", description: "The national flag of Greece.", usage: ["The ancient ruins of Athens.", "The beautiful islands of the Aegean Sea."] },
      { char: "🇬🇱", name: "Greenland", description: "The flag of Greenland.", usage: ["The largest island in the world.", "The stunning icebergs and glaciers of Greenland."] },
      { char: "🇬🇩", name: "Grenada", description: "The national flag of Grenada.", usage: ["The spice island of the Caribbean.", "The beautiful beaches and lush rainforests of Grenada."] },
      { char: "🇬🇵", name: "Guadeloupe", description: "The flag of Guadeloupe.", usage: ["The butterfly-shaped island of the Caribbean.", "A beautiful French overseas territory."] },
      { char: "🇬🇺", name: "Guam", description: "The flag of Guam.", usage: ["Where America's day begins.", "A beautiful island in the Pacific."] },
      { char: "🇬🇹", name: "Guatemala", description: "The national flag of Guatemala.", usage: ["The ancient Mayan ruins of Tikal.", "The beautiful Lake Atitlán."] },
      { char: "🇬🇬", name: "Guernsey", description: "The flag of Guernsey.", usage: ["A beautiful island in the English Channel.", "A British Crown Dependency."] },
      { char: "🇬🇳", name: "Guinea", description: "The national flag of Guinea.", usage: ["A country with rich mineral resources.", "The beautiful Fouta Djallon highlands."] },
      { char: "🇬🇼", name: "Guinea-Bissau", description: "The national flag of Guinea-Bissau.", usage: ["The beautiful Bijagós Archipelago.", "A country with a rich biodiversity."] },
      { char: "🇬🇾", name: "Guyana", description: "The national flag of Guyana.", usage: ["The land of many waters.", "The spectacular Kaieteur Falls."] },
      { char: "🇭🇹", name: "Haiti", description: "The national flag of Haiti.", usage: ["The first independent black republic.", "A country with a rich culture and history."] },
      { char: "🇭🇳", name: "Honduras", description: "The national flag of Honduras.", usage: ["The ancient Mayan ruins of Copán.", "The beautiful Bay Islands."] },
      { char: "🇭🇰", name: "Hong Kong SAR China", description: "The flag of Hong Kong.", usage: ["The vibrant city of Hong Kong.", "A fusion of East and West."] },
      { char: "🇭🇺", name: "Hungary", description: "The national flag of Hungary.", usage: ["The beautiful city of Budapest.", "The thermal baths of Hungary."] },
      { char: "🇮🇸", name: "Iceland", description: "The national flag of Iceland.", usage: ["The land of fire and ice.", "The magical Northern Lights."] },
      { char: "🇮🇳", name: "India", description: "The flag of India.", usage: ["Proud to be Indian 🇮🇳", "A taste of India.", "Happy Diwali!"] },
      { char: "🇮🇩", name: "Indonesia", description: "The national flag of Indonesia.", usage: ["The beautiful islands of Bali and Java.", "The largest archipelago in the world."] },
      { char: "🇮🇷", name: "Iran", description: "The national flag of Iran.", usage: ["The ancient history of Persia.", "The beautiful mosques of Isfahan."] },
      { char: "🇮🇶", name: "Iraq", description: "The national flag of Iraq.", usage: ["The cradle of civilization.", "The ancient city of Babylon."] },
      { char: "🇮🇪", name: "Ireland", description: "The national flag of Ireland.", usage: ["The Emerald Isle.", "A pint of Guinness in Dublin."] },
      { char: "🇮🇲", name: "Isle of Man", description: "The flag of the Isle of Man.", usage: ["The famous TT motorcycle race.", "A beautiful island in the Irish Sea."] },
      { char: "🇮🇹", name: "Italy", description: "The flag of Italy.", usage: ["A taste of Italy 🇮🇹", "When in Rome...", "Pizza and pasta forever."] },
      { char: "🇯🇲", name: "Jamaica", description: "The national flag of Jamaica.", usage: ["The land of reggae and Bob Marley.", "No problem, mon!"] },
      { char: "🇯🇵", name: "Japan", description: "The flag of Japan (Hinomaru).", usage: ["Welcome to Japan 🇯🇵", "I love sushi.", "A trip to Tokyo."] },
      { char: "🇯🇪", name: "Jersey", description: "The flag of Jersey.", usage: ["The largest of the Channel Islands.", "A beautiful British Crown Dependency."] },
      { char: "🇯🇴", name: "Jordan", description: "The national flag of Jordan.", usage: ["The ancient city of Petra.", "Floating in the Dead Sea."] },
      { char: "🇰🇿", name: "Kazakhstan", description: "The national flag of Kazakhstan.", usage: ["The vast steppes of Central Asia.", "A country with a rich nomadic heritage."] },
      { char: "🇰🇪", name: "Kenya", description: "The national flag of Kenya.", usage: ["A safari in the Maasai Mara.", "The Great Rift Valley."] },
      { char: "🇰🇮", name: "Kiribati", description: "The national flag of Kiribati.", usage: ["A beautiful island nation in the Pacific.", "At risk from climate change."] },
      { char: "🇽🇰", name: "Kosovo", description: "The national flag of Kosovo.", usage: ["The newest country in Europe.", "A country with a rich history and culture."] },
      { char: "🇰🇼", name: "Kuwait", description: "The national flag of Kuwait.", usage: ["The modern architecture of Kuwait City.", "A country with large oil reserves."] },
      { char: "🇰🇬", name: "Kyrgyzstan", description: "The national flag of Kyrgyzstan.", usage: ["The stunning mountains of the Tian Shan.", "A country with a rich nomadic culture."] },
      { char: "🇱🇦", name: "Laos", description: "The national flag of Laos.", usage: ["The laid-back atmosphere of Luang Prabang.", "A beautiful country in Southeast Asia."] },
      { char: "🇱🇻", name: "Latvia", description: "The national flag of Latvia.", usage: ["The beautiful city of Riga.", "A country with a rich history and culture."] },
      { char: "🇱🇧", name: "Lebanon", description: "The national flag of Lebanon.", usage: ["The Paris of the Middle East.", "A country with a rich history and delicious food."] },
      { char: "🇱🇸", name: "Lesotho", description: "The national flag of Lesotho.", usage: ["The Kingdom in the Sky.", "A country entirely surrounded by South Africa."] },
      { char: "🇱🇷", name: "Liberia", description: "The national flag of Liberia.", usage: ["Africa's first republic.", "A country with a rich history and beautiful beaches."] },
      { char: "🇱🇾", name: "Libya", description: "The national flag of Libya.", usage: ["The ancient Roman ruins of Leptis Magna.", "A country with a rich history in North Africa."] },
      { char: "🇱🇮", name: "Liechtenstein", description: "The national flag of Liechtenstein.", usage: ["A tiny, wealthy country in the Alps.", "A paradise for hikers and skiers."] },
      { char: "🇱🇹", name: "Lithuania", description: "The national flag of Lithuania.", usage: ["The beautiful city of Vilnius.", "A country with a rich history and culture."] },
      { char: "🇱🇺", name: "Luxembourg", description: "The national flag of Luxembourg.", usage: ["A small, wealthy country in the heart of Europe.", "A country with a rich history and beautiful castles."] },
      { char: "🇲🇴", name: "Macao SAR China", description: "The flag of Macao.", usage: ["The Las Vegas of Asia.", "A fusion of Portuguese and Chinese culture."] },
      { char: "🇲🇬", name: "Madagascar", description: "The national flag of Madagascar.", usage: ["The unique wildlife of Madagascar.", "The fourth largest island in the world."] },
      { char: "🇲🇼", name: "Malawi", description: "The national flag of Malawi.", usage: ["The warm heart of Africa.", "The beautiful Lake Malawi."] },
      { char: "🇲🇾", name: "Malaysia", description: "The national flag of Malaysia.", usage: ["A melting pot of cultures.", "The Petronas Towers in Kuala Lumpur."] },
      { char: "🇲🇻", name: "Maldives", description: "The national flag of the Maldives.", usage: ["A paradise of beautiful islands and overwater bungalows.", "A dream honeymoon destination."] },
      { char: "🇲🇱", name: "Mali", description: "The national flag of Mali.", usage: ["The ancient city of Timbuktu.", "The rich musical heritage of Mali."] },
      { char: "🇲🇹", name: "Malta", description: "The national flag of Malta.", usage: ["A beautiful island nation in the Mediterranean.", "A country with a rich history and culture."] },
      { char: "🇲🇭", name: "Marshall Islands", description: "The national flag of the Marshall Islands.", usage: ["A beautiful island nation in the Pacific.", "At risk from climate change."] },
      { char: "🇲🇶", name: "Martinique", description: "The flag of Martinique.", usage: ["The flower of the Caribbean.", "A beautiful French overseas territory."] },
      { char: "🇲🇷", name: "Mauritania", description: "The national flag of Mauritania.", usage: ["The vast Sahara desert in Mauritania.", "The ancient city of Chinguetti."] },
      { char: "🇲🇺", name: "Mauritius", description: "The national flag of Mauritius.", usage: ["A paradise island in the Indian Ocean.", "A melting pot of cultures."] },
      { char: "🇾🇹", name: "Mayotte", description: "The flag of Mayotte.", usage: ["A beautiful island in the Indian Ocean.", "A French overseas territory."] },
      { char: "🇲🇽", name: "Mexico", description: "The national flag of Mexico.", usage: ["The ancient ruins of Chichen Itza.", "The vibrant culture of Mexico City."] },
      { char: "🇫🇲", name: "Micronesia", description: "The national flag of Micronesia.", usage: ["A beautiful island nation in the Pacific.", "A paradise for divers."] },
      { char: "🇲🇩", name: "Moldova", description: "The national flag of Moldova.", usage: ["The land of wine.", "A country with a rich history and culture."] },
      { char: "🇲🇨", name: "Monaco", description: "The national flag of Monaco.", usage: ["The playground of the rich and famous.", "The famous Monte Carlo Casino."] },
      { char: "🇲🇳", name: "Mongolia", description: "The national flag of Mongolia.", usage: ["The land of Genghis Khan.", "The vast steppes of Central Asia."] },
      { char: "🇲🇪", name: "Montenegro", description: "The national flag of Montenegro.", usage: ["The pearl of the Mediterranean.", "The beautiful Bay of Kotor."] },
      { char: "🇲🇸", name: "Montserrat", description: "The flag of Montserrat.", usage: ["The Emerald Isle of the Caribbean.", "A beautiful island with an active volcano."] },
      { char: "🇲🇦", name: "Morocco", description: "The national flag of Morocco.", usage: ["The vibrant markets of Marrakech.", "The beautiful Sahara desert."] },
      { char: "🇲🇿", name: "Mozambique", description: "The national flag of Mozambique.", usage: ["The beautiful beaches of the Indian Ocean.", "A country with a rich culture and history."] },
      { char: "🇲🇲", name: "Myanmar (Burma)", description: "The national flag of Myanmar.", usage: ["The ancient temples of Bagan.", "A country with a rich culture and history."] },
      { char: "🇳🇦", name: "Namibia", description: "The national flag of Namibia.", usage: ["The stunning sand dunes of Sossusvlei.", "The vast and beautiful landscapes of Namibia."] },
      { char: "🇳🇷", name: "Nauru", description: "The national flag of Nauru.", usage: ["The smallest island nation in the world.", "A country with a unique history."] },
      { char: "🇳🇵", name: "Nepal", description: "The national flag of Nepal.", usage: ["The highest mountains in the world.", "The birthplace of Buddha."] },
      { char: "🇳🇱", name: "Netherlands", description: "The national flag of the Netherlands.", usage: ["The land of tulips and windmills.", "The beautiful canals of Amsterdam."] },
      { char: "🇳🇨", name: "New Caledonia", description: "The flag of New Caledonia.", usage: ["A beautiful island in the Pacific.", "A French overseas territory."] },
      { char: "🇳🇿", name: "New Zealand", description: "The national flag of New Zealand.", usage: ["The land of the long white cloud.", "The stunning landscapes of Middle-earth."] },
      { char: "🇳🇮", name: "Nicaragua", description: "The national flag of Nicaragua.", usage: ["The land of lakes and volcanoes.", "A country with a rich culture and history."] },
      { char: "🇳🇪", name: "Niger", description: "The national flag of Niger.", usage: ["The vast Sahara desert in Niger.", "A country with a rich culture and history."] },
      { char: "🇳🇬", name: "Nigeria", description: "The national flag of Nigeria.", usage: ["The giant of Africa.", "A country with a rich culture and vibrant music scene."] },
      { char: "🇳🇺", name: "Niue", description: "The flag of Niue.", usage: ["The rock of Polynesia.", "A beautiful island nation in the Pacific."] },
      { char: "🇳🇫", name: "Norfolk Island", description: "The flag of Norfolk Island.", usage: ["A beautiful island in the Pacific.", "A remote Australian territory."] },
      { char: "🇰🇵", name: "North Korea", description: "The national flag of North Korea.", usage: ["The most isolated country in the world.", "A country with a unique political system."] },
      { char: "🇲🇰", name: "North Macedonia", description: "The national flag of North Macedonia.", usage: ["The land of Alexander the Great.", "A country with a rich history and beautiful nature."] },
      { char: "🇲🇵", name: "Northern Mariana Islands", description: "The flag of the Northern Mariana Islands.", usage: ["A beautiful island chain in the Pacific.", "A commonwealth of the United States."] },
      { char: "🇳🇴", name: "Norway", description: "The national flag of Norway.", usage: ["The land of the midnight sun.", "The stunning fjords of Norway."] },
      { char: "🇴🇲", name: "Oman", description: "The national flag of Oman.", usage: ["The jewel of Arabia.", "A country with a rich history and beautiful landscapes."] },
      { char: "🇵🇰", name: "Pakistan", description: "The national flag of Pakistan.", usage: ["The land of the pure.", "A country with a rich history and diverse culture."] },
      { char: "🇵🇼", name: "Palau", description: "The national flag of Palau.", usage: ["A paradise for divers.", "A beautiful island nation in the Pacific."] },
      ...
      { char: "🇵🇦", name: "Panama", description: "The national flag of Panama.", usage: ["The crossroads of the world.", "The famous Panama Canal."] },
      { char: "🇵🇬", name: "Papua New Guinea", description: "The national flag of Papua New Guinea.", usage: ["The land of the unexpected.", "A country with a rich culture and incredible biodiversity."] },
      { char: "🇵🇾", name: "Paraguay", description: "The national flag of Paraguay.", usage: ["The heart of South America.", "A country with a rich history and culture."] },
      { char: "🇵🇪", name: "Peru", description: "The national flag of Peru.", usage: ["The land of the Incas.", "The ancient city of Machu Picchu."] },
      { char: "🇵🇭", name: "Philippines", description: "The national flag of the Philippines.", usage: ["The pearl of the orient seas.", "A country with beautiful beaches and friendly people."] },
      ...
      { char: "🇵🇳", name: "Pitcairn Islands", description: "The flag of the Pitcairn Islands.", usage: ["The most remote British overseas territory.", "Home to the descendants of the Bounty mutineers."] },
      { char: "🇵🇱", name: "Poland", description: "The national flag of Poland.", usage: ["A country with a rich history and culture.", "The beautiful city of Krakow."] },
      { char: "🇵🇹", name: "Portugal", description: "The national flag of Portugal.", usage: ["The land of explorers.", "The beautiful city of Lisbon."] },
      { char: "🇵🇷", name: "Puerto Rico", description: "The flag of Puerto Rico.", usage: ["The island of enchantment.", "A beautiful island in the Caribbean."] },
      { char: "🇶🇦", name: "Qatar", description: "The national flag of Qatar.", usage: ["A wealthy country in the Middle East.", "The host of the 2022 FIFA World Cup."] },
      ...
      { char: "🇷🇴", name: "Romania", description: "The national flag of Romania.", usage: ["The land of Dracula.", "A country with a rich history and beautiful castles."] },
      { char: "🇷🇺", name: "Russia", description: "The flag of Russia.", usage: ["From Russia with love 🇷🇺", "A visit to the Red Square.", "The vast landscapes of Siberia."] },
      { char: "🇷🇼", name: "Rwanda", description: "The national flag of Rwanda.", usage: ["The land of a thousand hills.", "A country with a remarkable story of reconciliation and progress."] },
      { char: "🇷🇪", name: "Réunion", description: "The flag of Réunion.", usage: ["A beautiful island in the Indian Ocean.", "A French overseas territory."] },
      { char: "🇼🇸", name: "Samoa", description: "The national flag of Samoa.", usage: ["The cradle of Polynesia.", "A beautiful island nation in the Pacific."] },
      { char: "🇸🇲", name: "San Marino", description: "The national flag of San Marino.", usage: ["The oldest republic in the world.", "A tiny, beautiful country in the heart of Italy."] },
      { char: "🇸🇦", name: "Saudi Arabia", description: "The national flag of Saudi Arabia.", usage: ["The birthplace of Islam.", "A country with a rich history and culture."] },
      { char: "🇸🇳", name: "Senegal", description: "The national flag of Senegal.", usage: ["The gateway to Africa.", "A country with a rich musical heritage."] },
      { char: "🇷🇸", name: "Serbia", description: "The national flag of Serbia.", usage: ["A country at the crossroads of Europe.", "The vibrant city of Belgrade."] },
      { char: "🇸🇨", name: "Seychelles", description: "The national flag of Seychelles.", usage: ["A paradise of beautiful islands in the Indian Ocean.", "A dream honeymoon destination."] },
      { char: "🇸🇱", name: "Sierra Leone", description: "The national flag of Sierra Leone.", usage: ["The land of diamonds.", "A country with beautiful beaches and a rich history."] },
      { char: "🇸🇬", name: "Singapore", description: "The national flag of Singapore.", usage: ["The lion city.", "A modern and vibrant city-state."] },
      { char: "🇸🇽", name: "Sint Maarten", description: "The flag of Sint Maarten.", usage: ["The friendly island.", "A beautiful island in the Caribbean, shared by two countries."] },
      { char: "🇸🇰", name: "Slovakia", description: "The national flag of Slovakia.", usage: ["The heart of Europe.", "A country with beautiful mountains and castles."] },
      { char: "🇸🇮", name: "Slovenia", description: "The national flag of Slovenia.", usage: ["The green heart of Europe.", "A country with stunning natural beauty."] },
      { char: "🇸🇧", name: "Solomon Islands", description: "The national flag of the Solomon Islands.", usage: ["A beautiful island nation in the Pacific.", "A paradise for divers."] },
      { char: "🇸🇴", name: "Somalia", description: "The national flag of Somalia.", usage: ["The Horn of Africa.", "A country with a rich history and culture."] },
      { char: "🇿🇦", name: "South Africa", description: "The national flag of South Africa.", usage: ["The rainbow nation.", "A country with a rich history and incredible biodiversity."] },
      { char: "🇬🇸", name: "South Georgia & South Sandwich Islands", description: "The flag of South Georgia & South Sandwich Islands.", usage: ["A remote and inhospitable part of the world.", "A haven for wildlife."] },
      { char: "🇰🇷", name: "South Korea", description: "The national flag of South Korea.", usage: ["The land of the morning calm.", "The home of K-pop and kimchi."] },
      { char: "🇸🇸", name: "South Sudan", description: "The national flag of South Sudan.", usage: ["The newest country in the world.", "A country with a rich culture and history."] },
      { char: "🇪🇸", name: "Spain", description: "The flag of Spain.", usage: ["Fiesta time! 🇪🇸", "A trip to Barcelona.", "Let's have some tapas."] },
      { char: "🇱🇰", name: "Sri Lanka", description: "The national flag of Sri Lanka.", usage: ["The pearl of the Indian Ocean.", "A country with beautiful beaches and ancient temples."] },
      { char: "🇧🇱", name: "St. Barthélemy", description: "The flag of St. Barthélemy.", usage: ["The playground of the rich and famous.", "A beautiful island in the Caribbean."] },
      { char: "🇸🇭", name: "St. Helena", description: "The flag of St. Helena.", usage: ["The island where Napoleon was exiled.", "A remote and beautiful island in the Atlantic."] },
      { char: "🇰🇳", name: "St. Kitts & Nevis", description: "The national flag of St. Kitts & Nevis.", usage: ["Two beautiful islands in the Caribbean.", "A paradise for nature lovers."] },
      { char: "🇱🇨", name: "St. Lucia", description: "The national flag of St. Lucia.", usage: ["The Helen of the West Indies.", "A beautiful island with the iconic Pitons."] },
      { char: "🇲🇫", name: "St. Martin", description: "The flag of St. Martin.", usage: ["The friendly island.", "A beautiful island in the Caribbean, shared by two countries."] },
      { char: "🇵🇲", name: "St. Pierre & Miquelon", description: "The flag of St. Pierre & Miquelon.", usage: ["A piece of France in North America.", "A beautiful archipelago off the coast of Newfoundland."] },
      { char: "🇻🇨", name: "St. Vincent & Grenadines", description: "The national flag of St. Vincent & Grenadines.", usage: ["A beautiful chain of islands in the Caribbean.", "A paradise for sailors."] },
      { char: "🇸🇩", name: "Sudan", description: "The national flag of Sudan.", usage: ["The land of the two Niles.", "A country with a rich history and ancient pyramids."] },
      { char: "🇸🇷", name: "Suriname", description: "The national flag of Suriname.", usage: ["The greenest country on Earth.", "A country with a rich culture and incredible biodiversity."] },
      { char: "🇸🇯", name: "Svalbard & Jan Mayen", description: "The flag of Svalbard & Jan Mayen.", usage: ["A remote archipelago in the Arctic Ocean.", "A haven for polar bears."] },
      { char: "🇸🇪", name: "Sweden", description: "The national flag of Sweden.", usage: ["The land of the midnight sun.", "The home of IKEA and ABBA."] },
      { char: "🇨🇭", name: "Switzerland", description: "The national flag of Switzerland.", usage: ["The land of mountains and chocolate.", "A neutral country in the heart of Europe."] },
      { char: "🇸🇾", name: "Syria", description: "The national flag of Syria.", usage: ["A country with a rich history and ancient cities.", "The cradle of civilization."] },
      { char: "🇸🇹", name: "São Tomé & Príncipe", description: "The national flag of São Tomé & Príncipe.", usage: ["The chocolate islands.", "A beautiful island nation off the coast of Africa."] },
      { char: "🇹🇼", name: "Taiwan", description: "The national flag of Taiwan.", usage: ["The heart of Asia.", "A country with a vibrant democracy and beautiful nature."] },
      { char: "🇹🇯", name: "Tajikistan", description: "The national flag of Tajikistan.", usage: ["The roof of the world.", "A country with stunning mountains and a rich culture."] },
      { char: "🇹🇿", name: "Tanzania", description: "The national flag of Tanzania.", usage: ["The land of safaris.", "The home of Mount Kilimanjaro and the Serengeti."] },
      { char: "🇹🇭", name: "Thailand", description: "The national flag of Thailand.", usage: ["The land of smiles.", "A country with beautiful beaches and delicious food."] },
      { char: "🇹🇱", name: "Timor-Leste", description: "The national flag of Timor-Leste.", usage: ["The newest country in Asia.", "A country with a rich history and beautiful nature."] },
      { char: "🇹🇬", name: "Togo", description: "The national flag of Togo.", usage: ["The smile of Africa.", "A country with a rich culture and beautiful beaches."] },
      { char: "🇹🇰", name: "Tokelau", description: "The flag of Tokelau.", usage: ["A remote atoll in the Pacific.", "A territory of New Zealand."] },
      { char: "🇹🇴", name: "Tonga", description: "The national flag of Tonga.", usage: ["The friendly islands.", "A beautiful island nation in the Pacific."] },
      ...
      { char: "🇹🇹", name: "Trinidad & Tobago", description: "The national flag of Trinidad & Tobago.", usage: ["The land of the hummingbird.", "The home of carnival and steelpan music."] },
      ...
      { char: "🇹🇳", name: "Tunisia", description: "The national flag of Tunisia.", usage: ["The gateway to North Africa.", "A country with a rich history and beautiful beaches."] },
      { char: "🇹🇷", name: "Turkey", description: "The national flag of Turkey.", usage: ["The crossroads of Europe and Asia.", "A country with a rich history and delicious food."] },
      { char: "🇹🇲", name: "Turkmenistan", description: "The national flag of Turkmenistan.", usage: ["The land of the golden horse.", "A country with a rich history and unique culture."] },
      { char: "🇹🇨", name: "Turks & Caicos Islands", description: "The flag of the Turks & Caicos Islands.", usage: ["Beautiful by nature.", "A paradise of beautiful islands and turquoise waters."] },
      { char: "🇹🇻", name: "Tuvalu", description: "The national flag of Tuvalu.", usage: ["A beautiful island nation in the Pacific.", "At risk from climate change."] },
      { char: "🇺🇬", name: "Uganda", description: "The national flag of Uganda.", usage: ["The pearl of Africa.", "A country with incredible biodiversity and friendly people."] },
      { char: "🇺🇦", name: "Ukraine", description: "The national flag of Ukraine.", usage: ["The breadbasket of Europe.", "A country with a rich history and culture."] },
      { char: "🇦🇪", name: "United Arab Emirates", description: "The national flag of the United Arab Emirates.", usage: ["The land of superlatives.", "The modern and vibrant city of Dubai."] },
      { char: "🇬🇧", name: "United Kingdom", description: "The flag of the United Kingdom (Union Jack).", usage: ["Keep calm and carry on 🇬🇧", "A trip to London.", "Tea and crumpets."] },
      { char: "🇺🇸", name: "United States", description: "The flag of the United States.", usage: ["God bless America 🇺🇸", "Made in the USA.", "Fourth of July celebrations."] },
      { char: "🇺🇾", name: "Uruguay", description: "The national flag of Uruguay.", usage: ["The land of the purple flower.", "A country with beautiful beaches and a relaxed atmosphere."] },
      { char: "🇻🇮", name: "U.S. Virgin Islands", description: "The flag of the U.S. Virgin Islands.", usage: ["America's Caribbean paradise.", "A beautiful chain of islands in the Caribbean."] },
      { char: "🇺🇿", name: "Uzbekistan", description: "The national flag of Uzbekistan.", usage: ["The heart of the Silk Road.", "A country with a rich history and stunning architecture."] },
      { char: "🇻🇺", name: "Vanuatu", description: "The national flag of Vanuatu.", usage: ["The land of volcanoes and magic.", "A beautiful island nation in the Pacific."] },
      { char: "🇻🇦", name: "Vatican City", description: "The flag of Vatican City.", usage: ["The smallest country in the world.", "The home of the Pope and the Catholic Church."] },
      { char: "🇻🇪", name: "Venezuela", description: "The national flag of Venezuela.", usage: ["The land of grace.", "A country with stunning natural beauty, including Angel Falls."] },
      { char: "🇻🇳", name: "Vietnam", description: "The national flag of Vietnam.", usage: ["The land of the ascending dragon.", "A country with a rich history and delicious food."] },
      { char: "🇼🇫", name: "Wallis & Futuna", description: "The flag of Wallis & Futuna.", usage: ["A beautiful island nation in the Pacific.", "A French overseas territory."] },
      { char: "🇪🇭", name: "Western Sahara", description: "The flag of Western Sahara.", usage: ["A disputed territory in North Africa.", "A land with a rich history and culture."] },
      { char: "🇾🇪", name: "Yemen", description: "The national flag of Yemen.", usage: ["The land of Sheba.", "A country with a rich history and unique architecture."] },
      { char: "🇿🇲", name: "Zambia", description: "The national flag of Zambia.", usage: ["The real Africa.", "The home of the magnificent Victoria Falls."] },
      { char: "🇿🇼", name: "Zimbabwe", description: "The national flag of Zimbabwe.", usage: ["The land of the great stone house.", "A country with a rich history and incredible wildlife."] },
    ],
  },
];
